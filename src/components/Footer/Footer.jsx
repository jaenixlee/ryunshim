    ...
    <div className={styles.container}>
      <div className={styles.footer}>
        <div className={styles.left}>
          ...
          <svg onClick={() => window.open("https://read.cv/ryunshim", "_blank")} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg onClick={() => window.open("https://scholar.google.com/citations?user=fVsZ4g8AAAAJ&hl=en&oi=sra", "_blank")} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
